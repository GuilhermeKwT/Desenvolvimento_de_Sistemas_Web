...
export class ProductService {
  ...
  addProduct(product: Product) : Observable<Product>{
    return this.http.post<Product>(`${this.apiURL}/products`, product, {headers: this.getAuthHeaders()});
  }
  ...
  deleteProduct(id: string) : Observable<void>{
    return this.http.delete<void>(`${this.apiURL}/products/${id}`, {headers: this.getAuthHeaders()});
  }
}
